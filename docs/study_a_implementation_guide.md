...
- **E6.2 — Correction mechanism = the accuracy-gated held-out supervised T\*
  ...
  [1.60, 4.88]** (the gate-passing τ_oc range — AMENDED 2026-07-20, GLM's
  gate-failed τ_oc excised: umbrella
  `spec/amendment_2026_07_20_band_glm_excision.md`). (REWRITTEN 2026-07-19 —
  supersedes the transferred
  ...
  instrument). Off-pair evidence: benefit band (1.00, 22.8] ⊇ [1.60, 4.88],
  coverage 0.965 (`spec/analysis_2026_07_19_q4_range_robustness.md` +
  its 2026-07-20 amendment block) — the
...
panel range [1.60, 4.88]** (the amended pre-registered band; criteria + grid +
bootstrap frozen per E6.2);
